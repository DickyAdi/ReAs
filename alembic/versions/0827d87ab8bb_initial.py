...
Revision ID: 0827d87ab8bb
Revises: 
Create Date: 2025-08-20 14:46:17.167997
...
def upgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('pending', 'success', 'failed', 'nores', name='dataset_status_enum'), nullable=False),
    sa.Column('provider', postgresql.ENUM('apify', 'local', name='dataset_provider_enum'), nullable=False),

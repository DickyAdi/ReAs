...
class inferenceModel(inferenceInterface):
    def __init__(self):
        ...
        self.model = biLSTM_Attention.load_from_checkpoint(checkpoint_path='artifacts/new_epoch=8-step=720.ckpt', embedding_matrix=_embedding_matrix, map_location='cpu')

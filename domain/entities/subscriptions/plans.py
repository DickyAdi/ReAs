...
class SubscriptionPlansEntity:
    ...
    subscriptions: Optional[List["SubscriptionEntity"]] = (
        None  # derived from database conditionally
    )
    ...
    def create(
        ...
        is_active: bool = True,
        related_tier: Optional["TierEntity"] = None,
        related_subcscription: Optional["SubscriptionEntity"] = None,
    ...
    @staticmethod
    def parse_tier_code(
        tier: "Tier", cycle: "SubscriptionPlan", currency: "Currency"
    ) -> str:
